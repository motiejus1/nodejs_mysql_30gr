...
// WHERE ee.employeeNumber = (:employeeNumber)
    ...
    databaseConnection.query('SELECT * FROM employees_employees ee LEFT JOIN offices o ON o.officeCode = ee.officeCode WHERE ee.employeeNumber ='+employeeNumber, function(err, rows){
       if(err) throw err;
